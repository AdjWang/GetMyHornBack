...
class Background extends EngineObject {
  constructor(sceneTheme) {
    ...
    const cloud1 = new TileInfo(vec2(96, 0), vec2(16 - 0.01, 7), textureInfos[TEXTURE_INDEX_CLOUD]);
    const cloud2 = new TileInfo(vec2(112, 2), vec2(16 - 0.01, 5), textureInfos[TEXTURE_INDEX_CLOUD]);
